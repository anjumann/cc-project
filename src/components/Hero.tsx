    ...
    <div className="bg-none">
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-200/70">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl pt-32 sm:py-48 lg:pt-56">

          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-100 sm:text-6xl">
              Empower Your Links, Elevate Your Reach.
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-200/70">
              Unleash the Potential of Your URLs with Our Short Link Creation Platform.
            </p>
